...
import { PhDeliverPriceEntryService } from './phdeliverprice-entry.service';

@Component({
  selector: 'app-phdeliverprice-entry',
  templateUrl: './phdeliverprice-entry.component.html',
  styleUrls: ['./phdeliverprice-entry.component.scss']
})

export class PhDeliverPriceEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhDeliverPriceEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhDeliverPriceEntryComponent>,
