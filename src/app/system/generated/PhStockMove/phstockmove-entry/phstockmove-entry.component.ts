...
import { PhStockMoveEntryService } from './phstockmove-entry.service';

@Component({
  selector: 'app-phstockmove-entry',
  templateUrl: './phstockmove-entry.component.html',
  styleUrls: ['./phstockmove-entry.component.scss']
})

export class PhStockMoveEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhStockMoveEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhStockMoveEntryComponent>,
