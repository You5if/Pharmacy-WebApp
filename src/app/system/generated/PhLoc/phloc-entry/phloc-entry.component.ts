...
import { PhLocEntryService } from './phloc-entry.service';

@Component({
  selector: 'app-phloc-entry',
  templateUrl: './phloc-entry.component.html',
  styleUrls: ['./phloc-entry.component.scss']
})

export class PhLocEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhLocEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhLocEntryComponent>,
