...
import { PhProdUnitEntryService } from './phprodunit-entry.service';

@Component({
  selector: 'app-phprodunit-entry',
  templateUrl: './phprodunit-entry.component.html',
  styleUrls: ['./phprodunit-entry.component.scss']
})

export class PhProdUnitEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhProdUnitEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhProdUnitEntryComponent>,
