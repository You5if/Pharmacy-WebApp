...
import { PhInvProdEntryService } from './phinvprod-entry.service';

@Component({
  selector: 'app-phinvprod-entry',
  templateUrl: './phinvprod-entry.component.html',
  styleUrls: ['./phinvprod-entry.component.scss']
})

export class PhInvProdEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhInvProdEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhInvProdEntryComponent>,
