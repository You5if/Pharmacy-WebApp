...
import { PhSaleConfEntryService } from './phsaleconf-entry.service';

@Component({
  selector: 'app-phsaleconf-entry',
  templateUrl: './phsaleconf-entry.component.html',
  styleUrls: ['./phsaleconf-entry.component.scss']
})

export class PhSaleConfEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhSaleConfEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhSaleConfEntryComponent>,
