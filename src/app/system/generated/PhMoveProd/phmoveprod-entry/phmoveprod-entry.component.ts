...
import { PhMoveProdEntryService } from './phmoveprod-entry.service';

@Component({
  selector: 'app-phmoveprod-entry',
  templateUrl: './phmoveprod-entry.component.html',
  styleUrls: ['./phmoveprod-entry.component.scss']
})

export class PhMoveProdEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhMoveProdEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhMoveProdEntryComponent>,
