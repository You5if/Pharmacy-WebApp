...
export class PhProdPriceEntryService {
    ...
    constructor(private _globals: AppGlobals,
        ...
        Controllers(model: Send) {
            return this.http.post(this._globals.baseAPIUrl + 'PhProdPrice/getuniventry', model, this._cf.requestOptions()).pipe(
           map((response: any) => {
        ...
        EntryA(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'PhProdPrice/createuniv',arr);
        }

        EntryE(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'PhProdPrice/edituniv',arr);
        }
        EntryA2(arr: any){
