...
import { PhProdPriceEntryService } from './phprodprice-entry.service';

@Component({
  selector: 'app-phprodprice-entry',
  templateUrl: './phprodprice-entry.component.html',
  styleUrls: ['./phprodprice-entry.component.scss']
})

export class PhProdPriceEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhProdPriceEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhProdPriceEntryComponent>,
