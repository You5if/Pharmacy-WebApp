...
import { PhDriverEntryService } from './phdriver-entry.service';

@Component({
  selector: 'app-phdriver-entry',
  templateUrl: './phdriver-entry.component.html',
  styleUrls: ['./phdriver-entry.component.scss']
})

export class PhDriverEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhDriverEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhDriverEntryComponent>,
