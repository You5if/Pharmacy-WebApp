...
import { NotificationEntryService } from './notification-entry.service';
...
export class NotificationEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: NotificationEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<NotificationEntryComponent>,
