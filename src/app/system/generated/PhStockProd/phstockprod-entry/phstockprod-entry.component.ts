...
import { PhStockProdEntryService } from './phstockprod-entry.service';

@Component({
  selector: 'app-phstockprod-entry',
  templateUrl: './phstockprod-entry.component.html',
  styleUrls: ['./phstockprod-entry.component.scss']
})

export class PhStockProdEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhStockProdEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhStockProdEntryComponent>,
