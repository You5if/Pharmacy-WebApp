...
import { PhProdGroupEntryService } from './phprodgroup-entry.service';

@Component({
  selector: 'app-phprodgroup-entry',
  templateUrl: './phprodgroup-entry.component.html',
  styleUrls: ['./phprodgroup-entry.component.scss']
})

export class PhProdGroupEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhProdGroupEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhProdGroupEntryComponent>,
