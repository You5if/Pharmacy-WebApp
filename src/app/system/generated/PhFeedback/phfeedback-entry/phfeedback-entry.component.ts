...
import { PhFeedbackEntryService } from './phfeedback-entry.service';

@Component({
  selector: 'app-phfeedback-entry',
  templateUrl: './phfeedback-entry.component.html',
  styleUrls: ['./phfeedback-entry.component.scss']
})

export class PhFeedbackEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhFeedbackEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhFeedbackEntryComponent>,
