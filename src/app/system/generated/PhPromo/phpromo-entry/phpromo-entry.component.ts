...
import { PhPromoEntryService } from './phpromo-entry.service';

@Component({
  selector: 'app-phpromo-entry',
  templateUrl: './phpromo-entry.component.html',
  styleUrls: ['./phpromo-entry.component.scss']
})

export class PhPromoEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhPromoEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhPromoEntryComponent>,
