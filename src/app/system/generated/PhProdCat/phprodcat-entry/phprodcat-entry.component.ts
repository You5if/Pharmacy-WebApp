...
import { PhProdCatEntryService } from './phprodcat-entry.service';

@Component({
  selector: 'app-phprodcat-entry',
  templateUrl: './phprodcat-entry.component.html',
  styleUrls: ['./phprodcat-entry.component.scss']
})

export class PhProdCatEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhProdCatEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhProdCatEntryComponent>,
