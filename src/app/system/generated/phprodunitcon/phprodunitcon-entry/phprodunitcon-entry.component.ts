...
import { PhProdUnitConEntryService } from './phprodunitcon-entry.service';

@Component({
  selector: 'app-phprodunitcon-entry',
  templateUrl: './phprodunitcon-entry.component.html',
  styleUrls: ['./phprodunitcon-entry.component.scss']
})

export class PhProdUnitConEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhProdUnitConEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhProdUnitConEntryComponent>,
