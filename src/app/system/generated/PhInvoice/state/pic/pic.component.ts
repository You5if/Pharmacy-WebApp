...
export class PicPageComponent implements OnInit {
    ...
    dropList: Sources[] = [];
    picImg:string = "http://pharmacyapi.autopay-mcs.com/"
  ...
  constructor(
    ...
    private dapiService: PhInvoiceEntryService,
      ...
      private dialogRef: MatDialogRef<PicPageComponent>,
      @Inject(MAT_DIALOG_DATA) public pModel: string
  ) { }

  ngOnInit() {
    console.log(this.pModel);
    this.picImg = "http://pharmacyapi.autopay-mcs.com/" + this.pModel
