...
import { PhTrackEntryService } from './phtrack-entry.service';

@Component({
  selector: 'app-phtrack-entry',
  templateUrl: './phtrack-entry.component.html',
  styleUrls: ['./phtrack-entry.component.scss']
})

export class PhTrackEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhTrackEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhTrackEntryComponent>,
