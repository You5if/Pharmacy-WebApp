...
import { PhProdStockEntryService } from './phprodstock-entry.service';

@Component({
  selector: 'app-phprodstock-entry',
  templateUrl: './phprodstock-entry.component.html',
  styleUrls: ['./phprodstock-entry.component.scss']
})

export class PhProdStockEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhProdStockEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhProdStockEntryComponent>,
