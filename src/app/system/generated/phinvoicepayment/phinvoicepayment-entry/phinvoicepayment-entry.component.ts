...
import { PhInvoicePaymentEntryService } from './phinvoicepaymententry.service';

@Component({
  selector: 'app-phinvoicepayment-entry',
  templateUrl: './phinvoicepayment-entry.component.html',
  styleUrls: ['./phinvoicepayment-entry.component.scss']
})

export class PhInvoicePaymentEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhInvoicePaymentEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhInvoicePaymentEntryComponent>,
