...
import { PhWarehouseEntryService } from './phwarehouse-entry.service';

@Component({
  selector: 'app-phwarehouse-entry',
  templateUrl: './phwarehouse-entry.component.html',
  styleUrls: ['./phwarehouse-entry.component.scss']
})

export class PhWarehouseEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: PhWarehouseEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<PhWarehouseEntryComponent>,
